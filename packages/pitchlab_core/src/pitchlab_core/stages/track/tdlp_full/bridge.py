"""The single process boundary between pitchlab and the external TDLP-full
...
contiguous 1..N MOT sequence, but pitchlab artifacts index by *source* video
...
from pitchlab_core.exchange import _parse_mot_tracklets
