...
#   pitchlab_core/_vendor/tdlp/*.py  (import prefix rewritten
#   `tdlp.architectures.tdlp` -> `pitchlab_core._vendor.tdlp`).
#
...
# feature transform, and feature assembly are re-implemented in the PitchLab
# idiom under `pitchlab_core/stages/track/tdlp/` (vendor-and-extend, per the
...
from pitchlab_core._vendor.tdlp.core import (
    MultiModalTDSP,
