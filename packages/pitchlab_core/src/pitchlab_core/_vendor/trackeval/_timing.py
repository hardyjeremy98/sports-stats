# Vendored from JonathonLuiten/TrackEval @ 12c8791 (trackeval/_timing.py),
# MIT License (see LICENSE in this directory). Unmodified except for this
# header. DO_TIMING defaults False, so `@time` is a transparent no-op
# decorator for our call path -- see package __init__.py for the full
# vendoring note.
