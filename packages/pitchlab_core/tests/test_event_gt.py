...
Distinct from the track/box-centric `GroundTruth` in `pitchlab_core.gt` --
...
`pitchlab_core.schemas.spotting.SpottedEvent` (Task 2) -- so the on-disk key
is literally "class".
"""
...
from pitchlab_core.event_gt import (
    EventGroundTruth,
    GroundTruthEvent,
