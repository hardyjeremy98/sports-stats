...
def test_export_frozen_detections_det_txt_rows(tmp_path):
    from matchlab_core.exchange import export_frozen_detections
...
def test_import_mot_tracklets_fixture(tmp_path):
    ...
    from matchlab_core.schemas.tracks import Tracklet
...
def test_import_mot_tracklets_frozen_hash_mismatch(tmp_path):
    from matchlab_core.exchange import export_frozen_detections, import_mot_tracklets
