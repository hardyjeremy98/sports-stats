...
from matchlab_core.provenance import RunProvenance, StageProvenance
from matchlab_core.registry import build
from matchlab_core.schemas.run import StageKind
from matchlab_core.stages.detect.rfdetr import RfDetrDetector
...
def test_dinov2_training_data_not_certifiable():
    from matchlab_core.stages.associate.embedders.dinov2 import LICENSE
