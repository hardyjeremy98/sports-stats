...
from matchlab_core.spotting.bridge import SpottingBridgeError, SpottingParams, run_spotter

_REFERENCE_COMMAND = [sys.executable, "-m", "matchlab_core.spotting.reference_cli"]
