...
from matchlab_core.schemas.run import VideoMeta
from matchlab_core.stages.detect.hosted_cache import SCHEMA, HostedDetectionCache, cache_key
...
def test_runner_records_post_detect_cache_hash_not_pre_run_empty_hash(tmp_path, monkeypatch):
    ...
    from matchlab_core.config import PipelineConfig, StageConfig, VideoConfig
