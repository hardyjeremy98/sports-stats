...
from matchlab_core.registry import build  # noqa: E402
from matchlab_core.schemas import (  # noqa: E402
    Box,
    Detection,
    DetectionClass,
    FrameDetections,
...
from matchlab_core.stages.associate.embedders.base import (  # noqa: E402
    BodyEmbedder,
    get_embedder,
    register_embedder,
)
