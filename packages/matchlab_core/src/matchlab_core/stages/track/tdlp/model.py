...
Constructs a `MultiModalTDSP` (vendored, MIT) over the MatchLab shippable cues:
...
from matchlab_core._vendor.tdlp import build_mm_tdsp_model
from matchlab_core.stages.track.tdlp.loop import FeatureSpec
