"""Offline TDLP association loop, re-implemented in the MatchLab idiom.

This is the ``vendor-and-extend`` counterpart to the vendored TDLP *head*
(`matchlab_core._vendor.tdlp`): the learned nn.Module is vendored verbatim
...
from matchlab_core.schemas import DetectionClass, Tracklet, TrackletFrame
...
class TDLPTracker:
    ...
    def track_clip(
        ...
        objects_data) with confidences already present. Returns MatchLab
