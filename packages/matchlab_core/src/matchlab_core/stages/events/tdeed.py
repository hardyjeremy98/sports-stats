...
reference spotter — as a subprocess via `matchlab_core.spotting.bridge`, and
...
from matchlab_core.schemas import ArtifactName, Event
from matchlab_core.schemas.run import StageKind
from matchlab_core.spotting.bridge import SpottingParams, run_spotter
...
_DEFAULT_COMMAND = [sys.executable, "-m", "matchlab_core.spotting.reference_cli"]
