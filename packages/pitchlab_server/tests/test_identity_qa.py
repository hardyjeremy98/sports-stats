...
os.environ.setdefault("PITCHLAB_DATA_DIR", tempfile.mkdtemp(prefix="pitchlab-test-"))
os.environ.setdefault(
    "PITCHLAB_DATABASE_URL", f"sqlite:///{os.environ['PITCHLAB_DATA_DIR']}/test.db"
)
os.environ.setdefault("PITCHLAB_CONFIG_DIR", str(Path(__file__).parents[3] / "configs"))
...
@pytest.fixture(scope="module")
def video_id(client):
    path = Path(os.environ["PITCHLAB_DATA_DIR"]) / "identity_qa_clip.mp4"
