"""`pitchlab-demo` — seed the local environment with a working demo:

1. render a synthetic match video (pitchlab_core.demo),
...
from pitchlab_server.models import Job, JobStatus, Run, RunStatus, Video
from pitchlab_server.settings import get_settings
from pitchlab_server.worker import execute_job


def main() -> None:
    parser = argparse.ArgumentParser(prog="pitchlab-demo")
