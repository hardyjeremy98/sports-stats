...
`MATCHLAB_CONFIG_DIR` override existing tests already use to redirect
`matchlab_server` settings, so pointing this at a tmp dir in tests is just
the standard settings-override fixture (see `matchlab_train/tests/
