...
in `matchlab_core.gt`) -- no ball/referee distinction, no team labels.
...
from matchlab_core.gt import load_sportsmot_sequence

from matchlab_train.datasets.stitch import stitch_frames_to_mp4
