...
import numpy as np
import torch
from matchlab_train.tdlp_head_train import load_states, sample_clip, save_states, train
...
def test_training_drives_loss_down_and_checkpoint_loads(tmp_path):
    ...
    from matchlab_core.stages.track.tdlp.model import ModalityConfig, build_head
