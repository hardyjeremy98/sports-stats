...
> IDsw, sub-bar on purity). **The shippable multi-cue TDLP program (SPO-36–44) is PAUSED
> (2026-07-19)**: its learned head does not beat this baseline without a SOTA-grade ReID
> appearance cue + permissive association-training data, both licensing-blocked (SPO-39) —
> see [`docs/reports/2026-07-19-spo42-assembled-shippable-tdlp.md`](reports/2026-07-19-spo42-assembled-shippable-tdlp.md) §4d.
